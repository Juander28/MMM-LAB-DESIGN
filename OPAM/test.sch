...
S {}
E {}
C {MMM-LAB DESIGN/OPAM/OPAM.sym} 700 -400 0 0 {name=x1}
C {devices/lab_pin.sym} 850 -430 0 0 {name=VDD lab=VDD}
C {devices/lab_pin.sym} 850 -410 0 0 {name=OUT lab=OUT}
C {devices/lab_pin.sym} 550 -430 0 0 {name=INN lab=INN}
C {devices/lab_pin.sym} 550 -410 0 0 {name=INP lab=INP}
C {devices/lab_pin.sym} 850 -390 0 0 {name=BIAS lab=BIAS}
C {devices/gnd.sym} 850 -370 0 0 {name=gvss lab=0}
...
C {devices/vsource.sym} 270 -650 0 0 {name=VCM value="4.00" savecurrent=false}
...
C {devices/vsource.sym} 510 -650 0 0 {name=V2 value="1.25" savecurrent=false}
C {devices/lab_pin.sym} 510 -680 0 0 {name=BIAS lab=BIAS}
C {devices/gnd.sym} 510 -620 0 0 {name=gV2 lab=0}
...
print v(OUT) v(x1.net1) v(x1.net2) v(x1.net3) v(x1.net7) v(x1.net8) v(x1.BOOT_R)
print i(VDD)
...
meas ac av_stage2 MAX vdb(x1.net7) from=0.1 to=1e6
