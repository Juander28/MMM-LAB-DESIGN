...
S {}
E {}
C {MMM-LAB DESIGN/OPAM/OPAM_BIASED.sym} 700 -400 0 0 {name=x1}
...
C {devices/vsource.sym} 270 -650 0 0 {name=VCM value="2.0" savecurrent=false}
...
print v(OUT) v(x1.net1) v(x1.net2) v(x1.net3) v(x1.net7) v(x1.net8) v(x1.BOOT_R) v(x1.BIAS)
print i(VDD)
...
meas tran vi_pp PP v(d)   FROM=$tk TO=$ts
